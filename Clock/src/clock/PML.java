...
public class PML extends JFrame {
	...
	public PML() {
		...
		lblMenuLabel.setForeground(Color.MAGENTA);
		...
		DigitalShapeComboBox.setModel(new DefaultComboBoxModel(new String[] {"Circle", "Square", "Triangle"}));
		...
		ColourBorderComboBox.setModel(new DefaultComboBoxModel(new String[] {"Red", "Green", "Blue", "Yellow"}));
		...
		ColourBackgroundComboBox.setModel(new DefaultComboBoxModel(new String[] {"Red", "Green", "Blue", "Yellow"}));
		...
		ColourFontComboBox.setModel(new DefaultComboBoxModel(new String[] {"Red", "Green", "Blue", "Yellow"}));
